  ...
  return (
    <div className="space-y-6 animate-fade-in">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
        <Card title="Pending Violations" icon={Clock} className="bg-gradient-to-br from-orange-50 to-amber-50">
          <div className="flex items-center gap-4">
            ...
            <div>
              ...
              <p className="text-sm text-orange-600">Awaiting resolution</p>
            </div>
          </div>
        </Card>

        <Card title="Resolved Violations" icon={CheckCircle} className="bg-gradient-to-br from-green-50 to-emerald-50">
          <div className="flex items-center gap-4">
